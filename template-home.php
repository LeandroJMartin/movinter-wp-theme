...
<section class="my-16 bg-bg-about bg-contain lg:bg-[length:40%_100%] bg-no-repeat">
  <div class="container lg:flex items-center">
    <div class="lg:w-2/4 pt-12">
      <img class="w-[87%] lg:w-full block m-auto" src="<?php echo get_template_directory_uri(); ?>/assets/img/a-feira.png" alt="Imagem sobre">
    </div>
    <div class="lg:w-2/4 p-4 sm:pl-24">
      ...
      <div class="grid grid-cols-3 gap-2 lg:gap-8 text-center">
        <div class="border 2xl:border-2 border-blue rounded-3xl p-2 lg:p-5">
          <img class="h-[35px] lg:h-[60px] block m-auto" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-1.png" alt="icone">
          <span class="text-blue text-xs lg:text-sm font-semibold mt-3 block">4 mil pessoas presentes</span>
        </div>
        <div class="border 2xl:border-2 border-blue rounded-3xl p-2 lg:p-5">
          <img class="h-[35px] lg:h-[60px] block m-auto" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-2.png" alt="icone">
          <span class="text-blue text-xs lg:text-sm font-semibold mt-3 block">Importadores de 6 países </span>
        </div>
        <div class="border 2xl:border-2 border-blue rounded-3xl p-2 lg:p-5">
          <img class="h-[35px] lg:h-[60px] block m-auto" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-3.png" alt="icone">
          <span class="text-blue text-xs lg:text-sm font-semibold mt-3 block">R$32 milhões em negócios fechados</span>
        </div>
      </div>
      <div class="mt-10 flex">
        <button class="uppercase text-xs lg:text-base w-auto lg:w-[200px] px-4 py-2 bg-violet text-white rounded-2xl">Seja um expositor</button>
        <button class="uppercase text-xs lg:text-base w-auto lg:w-[200px] px-4 py-2 border border-violet text-violet rounded-2xl ml-3 ">Visite a feira</button>
      </div>
    </div>
  </div>
</section>
...
<section class="container text-center pt-0 lg:pt-16 pb-8">
  <h1 class="text-xl xl:text-3xl text-violet uppercase font-semibold mb-8 block">Conheça os expositores já confirmados para 2023</h1>
