<footer class="border-t-[1px] border-t-blue/20">
  <div class="container pt-7">
    <div class="flex">
      ...
      <div class="w-1/3 justify-end flex">
        ...
        <div class="flex items-center">
          <img class="max-w-[100px] lg:max-w-[150px] 2xl:max-w-[250px]" src="<?php echo get_template_directory_uri(); ?>/assets/img/apoio/01.png" alt="Logo Poty">
          <img class="max-w-[100px] lg:max-w-[150px] 2xl:max-w-[250px] ml-4" src="<?php echo get_template_directory_uri(); ?>/assets/img/apoio/02.png" alt="Logo Senai">
          <img class="max-w-[100px] lg:max-w-[150px] 2xl:max-w-[250px] ml-4" src="<?php echo get_template_directory_uri(); ?>/assets/img/apoio/03.png" alt="Logo Scavaseg">
        </div>
      </div>
    </div>
    <div class="flex py-4 justify-center border-t-[1px] border-stone-300 mt-7">
